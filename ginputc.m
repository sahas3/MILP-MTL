...
%                         on specifying color. Default is 'k' (black). This is
%                         the cursor color.
%
%       'PointColor'      : A three-element RGB vector, or one of the MATLAB
%                         predefined names, specifying the line color. See
%                         the ColorSpec reference page for more information
%                         on specifying color. Default is 'k' (black). This is
%                         the color of the points selected. As well as the color
%                         of the line joining the selected points.
%
...
addParamValue(p, 'PointColor', 'k', @colorValidFcn);
